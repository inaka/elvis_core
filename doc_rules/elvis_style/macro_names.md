...
Macro names should consist only of uppercase alphanumeric characters.
...
Erlang documentation adopts the unquoted, uppercase naming convention recommended by Elvis as the
standard.
